...
import com.nsl.app.PlanScheduleFormActivity;
...
import static com.nsl.app.DatabaseHandler.KEY_TABLE_CUSTOMER_ID;
...
import static com.nsl.app.R.id.ll_select;
import static com.nsl.app.R.id.tvInvisibleError;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_savebooing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (role != Constants.Roles.ROLE_7) {
                    if (selected_company_id == null || selected_company_id == "0" || selected_customer_id == null || selected_customer_id == "0" || selected_division_id == null || selected_division_id == "0" || sel_moId ==null || sel_moId == "0") {
                ...
                /*else if (selected_customer_id == null || selected_customer_id == "0") {
                    ...
                    if (selected_company_id == null || selected_company_id == "0" || selected_customer_id == null || selected_customer_id == "0" || selected_division_id == null || selected_division_id == "0") {
    ...
    public class AsyncCustomersoffline extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String selectQuery = "SELECT  " + "CR." + KEY_TABLE_CUSTOMER_MASTER_ID + "," + KEY_TABLE_CUSTOMER_NAME + ",CDC." + KEY_TABLE_USER_COMPANY_CUSTOMER_CUSTOMER_ID + " FROM " + TABLE_USER_COMPANY_CUSTOMER + " AS CDC JOIN " + TABLE_CUSTOMERS + " AS CR ON CDC." + KEY_TABLE_USER_COMPANY_CUSTOMER_CUSTOMER_ID + " = CR." + KEY_TABLE_CUSTOMER_MASTER_ID + "  where " + "CDC." + KEY_TABLE_USER_COMPANY_CUSTOMER_COMPANY_ID + " = " + selected_company_id + " and " + KEY_TABLE_USER_COMPANY_CUSTOMER_USER_ID + " = " + sel_moId + " group by(CR." + KEY_TABLE_CUSTOMER_MASTER_ID + ")";
                sdbw = db.getWritableDatabase();
