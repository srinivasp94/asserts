...
import com.nsl.app.CropsFragmentSalesorderActivity;
            ...
            public void onClick(View view) {
                ...
                if (getIntent().getExtras()!=null && getIntent().getExtras().getString("selection")!=null && getIntent().getExtras().getString("selection","defaultKey").equalsIgnoreCase("distributor")) {
                    ...
                    if (sel_company_id == null || sel_company_id == "0" || sel_customer_id == null || sel_customer_id == "0" || sel_division_id == null || sel_division_id == "0") {
                        Toast.makeText(NewSalesOrderChooseActivity.this, "Please select Company, Customer and Division and go to booking ", Toast.LENGTH_SHORT).show();
                    }
