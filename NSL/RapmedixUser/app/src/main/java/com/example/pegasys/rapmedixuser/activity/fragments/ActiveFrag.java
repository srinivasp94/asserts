...
public class ActiveFrag extends Fragment implements RetrofitResponseListener {
                ...
                case 1:
                    ...
                    if (res.status.equals("success")) {
                        ...
                        for (int i = 0; i < appointmentsList.size(); i++) {
                            ...
                            if (appointmentsList.get(i).status.equals("1")) {
//                        mList.clear();
                                mList.add(model);
                            }
                        }
                        if (mList.size() == 0) {
                            ...
                            textView_nodata.setText("No Active Appointments yet");
                        }
                        calladapter();
    ...
    private void calladapter() {
        ...
        adapter.setOnItemClickListener(new AppointmentAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                new RetrofitRequester(ActiveFrag.this).callPostServices(obj, 2, "user/cancellappointment_service", true);
                adapter.notifyDataSetChanged();
